...
tetrisGame.IncrementTime = function(){
	...
	this.currentState[this.dotLocation1] = this.shapeType;
	this.currentState[this.dotLocation2] = this.shapeType;
	this.currentState[this.dotLocation3] = this.shapeType;
	this.currentState[this.dotLocation4] = this.shapeType;
