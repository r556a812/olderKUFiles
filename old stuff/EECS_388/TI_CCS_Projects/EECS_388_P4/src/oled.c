...
void OLEDTask(void *pvParameters){
	...
	unsigned long delay = ONE_MS * 250;
	...
	while(true) {
		...
		*/
	    ...
	    RIT128x96x4StringDraw(sysTickStr, 8, 32, 15);
	    RIT128x96x4StringDraw("Richard Aviles", 8, 8, 15);

	    if(xQueueReceive(queue, &value, ONE_MS * 250))
	    {
