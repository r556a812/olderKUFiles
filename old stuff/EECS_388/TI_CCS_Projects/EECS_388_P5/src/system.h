...
//  The BASE_FREQUENCY (1000 Hz) is used to create a tick multiplier -> ONE_MS
//  By using ONE_MS instead of SYSTICK_FREQUENCY we can freely change the system tick frequency
//  	without re-adjusting the timings of existing definitions.
//  ONE_MS is multiplied by the number of milliseconds between executions when creating tasks
