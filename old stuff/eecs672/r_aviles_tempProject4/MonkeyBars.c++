...
MonkeyBars::MonkeyBars(ShaderIF* sIF, double xStart, double xEnd, double zStart, double zEnd, double height, double k[3]) : SceneElement(sIF, *(new PhongMaterial(k[0], k[1], k[2])))
{
