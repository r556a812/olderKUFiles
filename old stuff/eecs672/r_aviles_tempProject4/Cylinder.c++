...
Cylinder::Cylinder(ShaderIF* sIF, double x1, double height, double zStart, double zEnd, double radius, double k[3]) : SceneElement(sIF, *(new PhongMaterial(k[0], k[1], k[2])))
{
